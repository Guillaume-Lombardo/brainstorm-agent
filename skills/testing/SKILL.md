...
- Preferred target: mirror `src/brainstorm_agent` structure under `tests/unit` for new or moved tests.
  - example: `src/brainstorm_agent/foo/bar.py` -> `tests/unit/foo/test_bar.py`
