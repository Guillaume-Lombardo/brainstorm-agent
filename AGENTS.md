...
- Example: `src/brainstorm_agent/foo/bar.py` maps to `tests/unit/foo/test_bar.py`.
...
- Verify `tests/unit` structure still mirrors `src/brainstorm_agent` after refactors/moves.
